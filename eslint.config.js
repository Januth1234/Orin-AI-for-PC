...
export default tseslint.config(
	...
	// All files (JS and TS)
	{
		...
		rules: {
			...
			'local/code-no-dangerous-type-assertions': 'off', // Orin warn -> off
			...
			// Orin - this should only apply to workbench/orin/
			// 'header/header': [
			// 	2,
			// 	'block',
			// 	[
	...
	// TS
	{
		...
		rules: {
			'@stylistic/ts/semi': 'off', // <-- Orin
			'@stylistic/ts/member-delimiter-style': 'off', // <-- Orin
			...
			'jsdoc/no-types': 'warn',
			'local/code-no-static-self-ref': 'off' // <-- Orin
		}
	},
	// vscode TS
	{
