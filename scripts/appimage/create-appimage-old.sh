...
if [ ! -f "./orin.png" ]; then
    echo "Error: orin.png icon not found in current directory"
    exit 1
fi
...
cp -v ./orin.png "$APP_DIR/orin.png"
cp -v ./orin.png "$APP_DIR/usr/share/icons/hicolor/256x256/apps/orin.png"
...
Type=Application
Categories=Utility;
Comment=Orin Linux Application
EOF
then
