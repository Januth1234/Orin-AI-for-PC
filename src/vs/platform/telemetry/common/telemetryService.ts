...
Orin separately records basic usage like the number of messages people are sending. If you'd like to disable Orin metrics, you may do so in Orin's Settings.
`;
