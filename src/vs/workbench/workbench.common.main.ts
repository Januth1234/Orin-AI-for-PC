...
//#region --- Orin
import './contrib/orin/browser/orin.contribution.js'; // Orin added this
//#endregion
...
// Chat
// Orin - this is still registered to avoid console errors, we just commented it out in chatParticipant.contribution.ts
