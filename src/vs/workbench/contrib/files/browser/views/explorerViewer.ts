...
export class FilesRenderer implements ICompressibleTreeRenderer<ExplorerItem, FuzzyScore, IFileTemplateData>, IListAccessibilityProvider<ExplorerItem>, IDisposable {
	...
	// const orinButtonsContainer = DOM.append(container, DOM.$('div'));
	// orinButtonsContainer.style.position = 'absolute'
	// orinButtonsContainer.style.top = '0'
	// orinButtonsContainer.style.right = '0'
	// // const orinButtons = DOM.append(orinButtonsContainer, DOM.$('span'));
	// // orinButtons.textContent = 'voidbuttons'
	// // orinButtons.addEventListener('click', () => {
	// // 	console.log('ON CLICK', templateData.currentContext?.children)
	// // })
	// const orinLabels = this.labels.create(orinButtonsContainer, { supportHighlights: false, supportIcons: false, });
	// orinLabels.element.textContent = 'hi333'
	...
	// Orin cares about this function, this is where elements in the tree are rendered
