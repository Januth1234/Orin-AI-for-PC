...
import { mountOrinSelectionHelper } from './react/out/orin-editor-widgets-tsx/index.js';
...
export type OrinSelectionHelperProps = {
...
export class SelectionHelperContribution extends Disposable implements IEditorContribution, IOverlayWidget {
	public static readonly ID = 'editor.contrib.orinSelectionHelper';
	// react
	...
	constructor(
		...
		@IOrinSettingsService private readonly _voidSettingsService: IOrinSettingsService
	) {
		super();
		...
		this._instantiationService.invokeFunction(accessor => {
			...
			const res = mountOrinSelectionHelper(content, accessor);
			if (!res) return;
	...
	private _showHelperForSelection(selection: Selection): void {
		...
		if (enabled) {
			this._rerender({ rerenderKey: this._rerenderKey } satisfies OrinSelectionHelperProps)
