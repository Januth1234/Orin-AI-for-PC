...
import { Diff, DiffArea, OrinFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	// testDiffs(): void;
	getOrinFileSnapshot(uri: URI): OrinFileSnapshot;
	restoreOrinFileSnapshot(uri: URI, snapshot: OrinFileSnapshot): void;
}
