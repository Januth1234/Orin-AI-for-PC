...
// The extension this was called from is here - https://github.com/orinai/orin/blob/autocomplete/extensions/orin/src/extension/extension.ts
...
export class AutocompleteService extends Disposable implements IAutocompleteService {
	...
	static readonly ID = 'orin.autocompleteService'
