...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/orin/common/orinSettingsTypes.js'
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js'
import { OrinSettingsState } from '../../../../../../../workbench/contrib/orin/common/orinSettingsService.js'
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js'
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/orin/common/refreshModelService.js'
...
import { IRefreshModelService } from '../../../../../../../workbench/contrib/orin/common/refreshModelService.js';
import { IOrinSettingsService } from '../../../../../../../workbench/contrib/orin/common/orinSettingsService.js';
import { IExtensionTransferService } from '../../../../../../../workbench/contrib/orin/browser/extensionTransferService.js'
...
let settingsState: OrinSettingsState
const settingsStateListeners: Set<(s: OrinSettingsState) => void> = new Set()
...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		settingsStateService: accessor.get(IOrinSettingsService),
		refreshModelService: accessor.get(IRefreshModelService),
		themeService: accessor.get(IThemeService),
		editCodeService: accessor.get(IEditCodeService),
		orinCommandBarService: accessor.get(IOrinCommandBarService),
		modelService: accessor.get(IModelService),
		mcpService: accessor.get(IMCPService),
	}

	const { settingsStateService, chatThreadsStateService, refreshModelService, themeService, editCodeService, orinCommandBarService, modelService, mcpService } = stateServices
	...
	disposables.push(
		orinCommandBarService.onDidChangeState(({ uri }) => {
			commandBarURIStateListeners.forEach(l => l(uri));
		})
	)

	disposables.push(
		orinCommandBarService.onDidChangeActiveURI(({ uri }) => {
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		IOrinSettingsService: accessor.get(IOrinSettingsService),
		...
		IOrinModelService: accessor.get(IOrinModelService),
		IWorkspaceContextService: accessor.get(IWorkspaceContextService),

		IOrinCommandBarService: accessor.get(IOrinCommandBarService),
...
export const useAccessor = () => {
	if (!reactAccessor_) {
		throw new Error(`⚠️ Orin useAccessor was called before _registerServices!`)
	}
