...
import { TextAreaFns, OrinInputBox2 } from '../util/inputs.js';
import { QuickEditPropsType } from '../../../quickEditActions.js';
import { ButtonStop, ButtonSubmit, IconX, OrinChatArea } from '../sidebar-tsx/SidebarChat.js';
import { ORIN_CTRL_K_ACTION_ID } from '../../../actionIDs.js';
import { useRefState } from '../util/helpers.js';
import { isFeatureNameDisabled } from '../../../../../../../workbench/contrib/orin/common/orinSettingsTypes.js';
...
export const QuickEditChat = ({
	...
	const loadingIcon = <div
		className="@@codicon @@codicon-loading @@codicon-modifier-spin @@codicon-no-default-spin text-orin-fg-3"
	/>
	...
	const keybindingString = accessor.get('IKeybindingService').lookupKeybinding(ORIN_CTRL_K_ACTION_ID)?.getLabel()
