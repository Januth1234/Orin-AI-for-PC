	...
	theme: {
		extend: {
			typography: theme => ({
				DEFAULT: {
					css: {
						'--tw-prose-body': 'var(--orin-fg-1)',
						'--tw-prose-headings': 'var(--orin-fg-1)',
						'--tw-prose-lead': 'var(--orin-fg-2)',
						'--tw-prose-links': 'var(--orin-link-color)',
						'--tw-prose-bold': 'var(--orin-fg-1)',
						'--tw-prose-counters': 'var(--orin-fg-3)',
						'--tw-prose-bullets': 'var(--orin-fg-3)',
						'--tw-prose-hr': 'var(--orin-border-4)',
						'--tw-prose-quotes': 'var(--orin-fg-1)',
						'--tw-prose-quote-borders': 'var(--orin-border-2)',
						'--tw-prose-captions': 'var(--orin-fg-3)',
						'--tw-prose-code': 'var(--orin-fg-0)',
						'--tw-prose-pre-code': 'var(--orin-fg-0)',
						'--tw-prose-pre-bg': 'var(--orin-bg-1)',
						'--tw-prose-th-borders': 'var(--orin-border-4)',
						'--tw-prose-td-borders': 'var(--orin-border-4)',
					},
				},
			}),
			fontSize: {
			...
			colors: {
				'orin-bg-1': 'var(--orin-bg-1)',
				'orin-bg-1-alt': 'var(--orin-bg-1-alt)',
				'orin-bg-2': 'var(--orin-bg-2)',
				'orin-bg-2-alt': 'var(--orin-bg-2-alt)',
				'orin-bg-2-hover': 'var(--orin-bg-2-hover)',
				'orin-bg-3': 'var(--orin-bg-3)',


				'orin-fg-0': 'var(--orin-fg-0)',
				'orin-fg-1': 'var(--orin-fg-1)',
				'orin-fg-2': 'var(--orin-fg-2)',
				'orin-fg-3': 'var(--orin-fg-3)',
				// 'orin-fg-4': 'var(--vscode-tab-inactiveForeground)',
				'orin-fg-4': 'var(--orin-fg-4)',

				'orin-warning': 'var(--orin-warning)',
				'orin-accent': 'var(--orin-accent)',

				'orin-border-1': 'var(--orin-border-1)',
				'orin-border-2': 'var(--orin-border-2)',
				'orin-border-3': 'var(--orin-border-3)',
				'orin-border-4': 'var(--orin-border-4)',

				'orin-ring-color': 'var(--orin-ring-color)',
				'orin-link-color': 'var(--orin-link-color)',
