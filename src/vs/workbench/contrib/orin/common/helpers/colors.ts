...
// gets converted to --vscode-orin-greenBG, see orin.css, asCssVariable
registerColor('orin.greenBG', configOfBG(acceptBG), '', true);
registerColor('orin.redBG', configOfBG(rejectBG), '', true);
registerColor('orin.sweepBG', configOfBG(sweepBG), '', true);
registerColor('orin.highlightBG', configOfBG(highlightBG), '', true);
registerColor('orin.sweepIdxBG', configOfBG(sweepIdxBG), '', true);
