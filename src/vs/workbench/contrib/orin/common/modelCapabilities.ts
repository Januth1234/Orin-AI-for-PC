...
import { FeatureName, ModelSelectionOptions, OverridesOfModel, ProviderName } from './orinSettingsTypes.js';
...
export type OrinStaticModelInfo = { // not stateful
	// Orin uses the information below to know how to handle each model.
...
type OrinStaticProviderInfo = { // doesn't change (not stateful)
	...
	modelOptions: { [key: string]: OrinStaticModelInfo };
	modelOptionsFallback: (modelName: string, fallbackKnownValues?: Partial<OrinStaticModelInfo>) => (OrinStaticModelInfo & { modelName: string, recognizedModelName: string }) | null;
}
...
const defaultModelOptions = {
	...
	supportsFIM: false,
	reasoningCapabilities: false,
} as const satisfies OrinStaticModelInfo
...
} as const satisfies { [s: string]: Partial<OrinStaticModelInfo> }




// keep modelName, but use the fallback's defaults
const extensiveModelOptionsFallback: OrinStaticProviderInfo['modelOptionsFallback'] = (modelName, fallbackKnownValues) => {

	const lower = modelName.toLowerCase()

	const toFallback = <T extends { [s: string]: Omit<OrinStaticModelInfo, 'cost' | 'downloadable'> },>(obj: T, recognizedModelName: string & keyof T)
		: OrinStaticModelInfo & { modelName: string, recognizedModelName: string } => {
...
} as const satisfies { [s: string]: OrinStaticModelInfo }

const anthropicSettings: OrinStaticProviderInfo = {
...
const openAISettings: OrinStaticProviderInfo = {
...
const xAISettings: OrinStaticProviderInfo = {
...
const geminiSettings: OrinStaticProviderInfo = {
...
const deepseekSettings: OrinStaticProviderInfo = {
...
const mistralSettings: OrinStaticProviderInfo = {
...
const groqSettings: OrinStaticProviderInfo = {
...
} as const satisfies Record<string, OrinStaticModelInfo>
const googleVertexSettings: OrinStaticProviderInfo = {
...
const microsoftAzureSettings: OrinStaticProviderInfo = {
...
const awsBedrockSettings: OrinStaticProviderInfo = {
...
const vLLMSettings: OrinStaticProviderInfo = {
...
const lmStudioSettings: OrinStaticProviderInfo = {
...
const ollamaSettings: OrinStaticProviderInfo = {
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
...
const openaiCompatible: OrinStaticProviderInfo = {
...
const liteLLMSettings: OrinStaticProviderInfo = { // https://docs.litellm.ai/docs/reasoning_content
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
	modelOptions: {},
	providerReasoningIOSettings: {
		input: { includeInPayload: openAICompatIncludeInPayloadReasoning },
...
const openRouterSettings: OrinStaticProviderInfo = {
...
const modelSettingsOfProvider: { [providerName in ProviderName]: OrinStaticProviderInfo } = {
