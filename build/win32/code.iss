...
; this is a // Orin icon comment. Old: WizardImageFile="{#RepoDir}\resources\win32\inno-big-100.bmp,{#RepoDir}\resources\win32\inno-big-125.bmp,{#RepoDir}\resources\win32\inno-big-150.bmp,{#RepoDir}\resources\win32\inno-big-175.bmp,{#RepoDir}\resources\win32\inno-big-200.bmp,{#RepoDir}\resources\win32\inno-big-225.bmp,{#RepoDir}\resources\win32\inno-big-250.bmp"
; this is a // Orin icon comment. Old: WizardSmallImageFile="{#RepoDir}\resources\win32\inno-small-100.bmp,{#RepoDir}\resources\win32\inno-small-125.bmp,{#RepoDir}\resources\win32\inno-small-150.bmp,{#RepoDir}\resources\win32\inno-small-175.bmp,{#RepoDir}\resources\win32\inno-small-200.bmp,{#RepoDir}\resources\win32\inno-small-225.bmp,{#RepoDir}\resources\win32\inno-small-250.bmp"
; COMMENTED OUT WizardImageFile=""
WizardSmallImageFile="{#RepoDir}\resources\win32\inno-orin.bmp,{#RepoDir}\resources\win32\inno-orin.bmp,{#RepoDir}\resources\win32\inno-orin.bmp,{#RepoDir}\resources\win32\inno-orin.bmp,{#RepoDir}\resources\win32\inno-orin.bmp,{#RepoDir}\resources\win32\inno-orin.bmp,{#RepoDir}\resources\win32\inno-orin.bmp"
SetupIconFile={#RepoDir}\resources\win32\orin.ico
